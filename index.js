...
const mongoString = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@blog.lga6qzh.mongodb.net/blog?retryWrites=true&w=majority`
...
app.use(cors({
  origin: process.env.NODE_ENV === "development" ? config.devAdminURL : /admin.erikjohns\.com$/,
  credentials: true
}))
